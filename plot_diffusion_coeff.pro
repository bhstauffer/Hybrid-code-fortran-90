...
files=['./run_b0.5_v3_4/','./run_b1_v3_4/','./run_b2_v3_4/','./run_b3_v3_4/','./run_b4_v3_4/','./run_b5_v3_4/','./run_b6_v3_4/','./run_b7_v3_4/','./run_test/']
...
xarr = [0.5,1,2,3,4,5,6,7,8]
;b2 = barplot(xarr,(f-s)/1e9, bottom_color="white", fill_color='yellow', index=0,name='beta 1.0',xtick;dir=1,ytickdir=1)
b = barplot(xarr,f/1e11, bottom_color="white",fill_color='red', index=0,name='beta 1.0',xtickdir=1,ytickdir=1,xminor=0)
...
b = errorplot(xarr,f/1e11,s/1e11,/overplot,linestyle=6,thick=2)

;b.title='$\beta$ = 1.0'
b.xtitle='plasma $\beta$'
b.ytitle='$D (10^{11} m^2/s)$'

;b1 = barplot(xarr,f1/1e9, nbars = 2, fill_color='blue',index=1,/overplot,name='beta 0.5')

;l = legend(target=[b,b1])

b.save,"diff_coeff_beta.png"

xarr = 0.8/sqrt(1 + ((5./3.)/2)*[0.5,1,2,3,4,5,6,7])
b = barplot(xarr,f/1e11, bottom_color="white",fill_color='red', index=0,name='beta 1.0',xtickdir=1,ytickdir=1,xminor=0,width=0.2)
b = errorplot(xarr,f/1e11,s/1e11,/overplot,linestyle=6,thick=2)

b.xrange=[0.3,0.7]
;b.title='$\beta$ = 1.0'
b.xtitle='$M_f = 0.8/(1-\gamma \beta/2)^{1/2}$'
b.ytitle='$D (10^{11} m^2/s)$'

b.save,"diff_coeff_Mach_f.png"
