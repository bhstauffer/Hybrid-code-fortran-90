...
;                       + edotbarr(round(xIndices(ii)),round(yIndices(ii)),round(zIndices(ii)))
      ...
      if (ds gt 0) then begin
         ...
         btot_pfl = [btot_pfl,sqrt(b1(xind,yind,zind,0)^2 + b1(xind,yind,zind,1)^2 + b1(xind,yind,zind,2)^2)/(q*b0_top/mproton)]
         upxpfl = [upxpfl,up(xind,yind,zind,0)/valfven]
         ajypfl = [ajypfl,aj(xind,yind,zind,1)]

         pltnum=2
         p = plot(s(1:*),mixpfl(1:*),/current,layout=[1,nplts,pltnum],/xsty,/ysty,/buffer)
         ...
         pltnum=3
         p0 = plot(s(1:*),upxpfl(1:*),'r',/current,layout=[1,nplts,pltnum],/xsty,/ysty,/buffer)
         ...
         pltnum=4
         p2 = plot(s(1:*),bperp_pfl(1:*),/current,layout=[1,nplts,pltnum],/xsty,/ysty,/buffer)
         ...
         pltnum=5
         p1 = plot(s(1:*), eparpfl(1:*),/current,layout=[1,nplts,pltnum],/xsty,/ysty,/buffer)
         ...
         pltnum=6
         p3 = plot(s(1:*),epotpfl(1:*),/current,layout=[1,nplts,pltnum],/xsty,/ysty,/buffer)
...
wfv.save,'./prl_nu_001_noscale/fv'+strcompress(string(i),/remove_all)+'.png'
epar = eparpfl(1:*)
btot = btot_pfl(1:*)
d = s(1:*)
help,epar,btot,d
save,filename='./prl_nu_001_noscale/fv'+strcompress(string(i),/remove_all)+'.sav',epar,btot,d,coverwpi
F_of_alpha = fltarr(36)
eparpfl = 0
bperp_pfl = 0
btot_pfl = 0
